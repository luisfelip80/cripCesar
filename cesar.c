...
int main(void)
{
	...
	char texto_str[900];
	char texto [1000000];
	char nome[30], nome1[20], nome2[20];
	int i,j,l,result;
	int soma = 0, cesar;
	printf("Apenas aquivos txt, nao precisa colocar o \".txt\" no final no nome.\n");
	printf("Nome do arquivo para criptografar: ");
	scanf("%s", nome1);
	printf("Nome do arquivo de sainda (sem o \".txt\"): ");
	scanf("%s", nome2);
	printf("Palavra chave para criptografar: ");
	scanf(" %[^\n]s", nome);
